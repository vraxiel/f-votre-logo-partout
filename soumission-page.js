...
(function () {
  ...
  const PLACEMENTS_DTF = [
    ...
    { value:'arriere-petit',       label:'Arriere',          size:'Zone max 11" x 6,5"', price:3.75,  zone:'arriere',       groupe:'moyen' },
    { value:'arriere',             label:'Arriere',          size:'Zone max 11" x 11"',  price:6.60,  zone:'arriere',       groupe:'grand' },
    { value:'arriere-max',         label:'Arriere',          size:'Zone max 14" x 14"',  price:11.40, zone:'arriere',       groupe:'max' },
